...
fun LoginScreen(
    ...
    Column(
        ...
        Text(
            text = AuthConstants.LOGIN_TITLE,
        ...
        Text(
            text = AuthConstants.LOGIN_SUBTITLE,
        ...
        Button(
            ...
            Text(AuthConstants.LOGIN_BUTTON)
        }
        ...
        Row(
            ...
            Text(AuthConstants.LOGIN_NO_ACCOUNT)
            TextButton(onClick = onNavigateToRegister) {
                Text(AuthConstants.LOGIN_REGISTER_LINK)
            }
        }
    }
}
